        ...
        <div className="flex flex-wrap justify-between items-center mx-auto min-[1600px]:max-w-[1600px] min-[1400px]:max-w-[1320px] min-[1200px]:max-w-[1140px] min-[992px]:max-w-[960px] min-[768px]:max-w-[720px] min-[576px]:max-w-[540px]">
          <div className="w-full flex flex-wrap mt-[-12px] mb-[-12px]">
            <div className="min-[992px]:w-[25%] min-[576px]:w-[50%] w-full p-[12px] wow fadeInUp">
              <div className="gi-ser-inner transition-all duration-[0.3s] ease delay-[0s] p-[20px] max-[991px]:p-[24px] h-full flex items-center justify-center flex-col text-center bg-[#fff] border-[1px] border-solid border-[#eee]">
            ...
            <div
              className="min-[992px]:w-[25%] min-[576px]:w-[50%] w-full p-[12px] wow fadeInUp"
              data-wow-delay=".4s"
            >
              <div className="gi-ser-inner transition-all duration-[0.3s] ease delay-[0s] p-[20px] max-[991px]:p-[24px] h-full flex items-center justify-center flex-col text-center bg-[#fff] border-[1px] border-solid border-[#eee]">
                <div className="gi-service-image mb-[15px]">
                  <i className="fi fi-ts-hand-holding-seeding text-[40px] text-[#5caf90] leading-[0]"></i>
                </div>
                <div className="gi-service-desc">
                  <h3 className="font-Poppins text-[18px] font-medium text-[#4b5966] leading-[1.2] tracking-[0.6px] mb-[10px] max-[575px]:text-[16px]">
                    24X7 Support
            ...
            >
              <div className="gi-ser-inner transition-all duration-[0.3s] ease delay-[0s] p-[20px] max-[991px]:p-[24px] h-full flex items-center justify-center flex-col text-center bg-[#fff] border-[1px] border-solid border-[#eee]">
                <div className="gi-service-image mb-[15px]">
                  <i className="fi fi-ts-badge-percent text-[40px] text-[#5caf90] leading-[0]"></i>
                </div>
                <div className="gi-service-desc">
                  <h3 className="font-Poppins text-[18px] font-medium text-[#4b5966] leading-[1.2] tracking-[0.6px] mb-[10px] max-[575px]:text-[16px]">
                    30 Days Return
            ...
            >
              <div className="gi-ser-inner transition-all duration-[0.3s] ease delay-[0s] p-[20px] max-[991px]:p-[24px] h-full flex items-center justify-center flex-col text-center bg-[#fff] border-[1px] border-solid border-[#eee]">
                <div className="gi-service-image mb-[15px]">
                  <i className="fi fi-ts-donate text-[40px] text-[#5caf90] leading-[0]"></i>
                </div>
                <div className="gi-service-desc">
                  <h3 className="font-Poppins text-[18px] font-medium text-[#4b5966] leading-[1.2] tracking-[0.6px] mb-[10px] max-[575px]:text-[16px]">
                    Payment Secure
