        ...
        <div className="grid md:grid-cols-2 gap-4 items-center  overflow-hidden">
          <div className="relative w-full h-full md:min-h-[470px]">
            <div className="grid md:grid-cols-2 gap-8 max-md:max-w-lg mx-auto">
              <div className="text-left bg-[#DEA776] rounded-lg shadow p-6   mx-2 sm:mx-0 md:mx-0 lg:mx-0 ">
                <svg
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Proven India gives you the choice of Copper Charged RO water
                  and Normal Water.
                </p>
              </div>

              <div className="text-left bg-blue-50 rounded-lg shadow p-6 mx-2 sm:mx-0 md:mx-0 lg:mx-0">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  Charge RO water with 99.8% with pure Copper, in Real time.
                </p>
              </div>
              ...
              <div className="text-left bg-[#DEA776] rounded-lg shadow p-6 mx-2 sm:mx-0 md:mx-0 lg:mx-0">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">
                  ...
                  fresh cooper infusion at all times.
                </p>
              </div>
            </div>
          </div>
          ...
          <h6 className="sm:text-md text-md font-bold  text-AFPPrimary ">
            ...
            <div className="mt-2">
              <p className=" text-justify">
                We, at Proven Water Industries Pvt. Ltd., have one goal – to
                ensure the best of health at all times. We all know prevention
                is better than cure. But when we have the world-class and
                innovative OrpH+ technology for getting 100% sure water while
                maintaining the ORP and pH levels including essential minerals
                for boosting immunity and holistic good health, we don’t just
                prevent the diseases, we ensure good health at all times. With
                Proven Ro, you can always Be Health Sure!
              </p>
            </div>
          </div>
        </div>
